...
package com.dnd.privacyapp.widgets;
 ...
 * 
 * @author jsaund
 *  Link: http://www.jagsaund.com/blog/2011/11/25/customizing-your-progress-bar-part-two.html
 */
public class SaundProgressBar extends ProgressBar {
  ...
  public SaundProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    if (a != null) {
      m_textPaint.setTextSize(a.getDimension(R.styleable.SaundProgressBar_textSize, 10));
      m_textPaint.setColor(a.getColor(R.styleable.SaundProgressBar_textColor, Color.WHITE));
      
      int alignIndex = (a.getInt(R.styleable.SaundProgressBar_textAlign, 1));
      if (alignIndex == 0) {
      ...
      int textStyle = (a.getInt(R.styleable.SaundProgressBar_textStyle, 1));
      if (textStyle == 0) {
      ...
      m_indicator = a.getDrawable(R.styleable.SaundProgressBar_progressIndicator);
      
      m_offset = (int) a.getDimension(R.styleable.SaundProgressBar_offset, 0);
   ...
   * {@linkplain SaundProgressBar.Formatter} interface.
   * 
   * @param formatter
   */
