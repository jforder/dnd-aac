...
public class DownloaderActivity extends Activity implements IDownloaderClient {
    ...
    private static final XAPKFile[] xAPKS = {
            //new XAPKFile(true, 5, 687801613L)
    	new XAPKFile(true, 1, 78796571L)
            // main file only
    };
    ...
    boolean expansionFilesDelivered() {
        for (XAPKFile xf : xAPKS) {
            ...
            File xapk = new File(path);
            if(!xapk.exists()){ //do not check file size
            	return false;
            }
//            if (!Helpers.doesFileExist(this, fileName, xf.mFileSize, false)){ //this validates file size
    ...
    void validateXAPKZipFiles() {
        ...
        AsyncTask<Object, DownloadProgressInfo, Boolean> validationTask = new AsyncTask<Object, DownloadProgressInfo, Boolean>() {
            ...
            protected Boolean doInBackground(Object... params) {
                for (XAPKFile xf : xAPKS) {
                    String fileName = Helpers.getExpansionAPKFileName(DownloaderActivity.this,
        ...
        if (!expansionFilesDelivered()) {
            ...
            try {
                Intent launchIntent = DownloaderActivity.this
                        .getIntent();
                Intent intentToLaunchThisActivityFromNotification = new Intent(DownloaderActivity
                ...
                PendingIntent pendingIntent = PendingIntent.getActivity(DownloaderActivity.this,
        	...
        	//initializeDownloadUI();
            //validateXAPKZipFiles(); //initialize UI and validate file
